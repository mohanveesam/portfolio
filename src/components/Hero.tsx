...
const Hero = () => {
  const handleDownloadResume = () => {
    ...
    link.href = '/mohan-veesam.pdf'; // Add your resume file to public folder
  ...
  const handleViewResume = () => {
    ...
    window.open('/mohan-veesam.pdf', '_blank');
  };
        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="animate-fade-in-up" style={{animationDelay: '0.2s'}}>
            <p className="text-xl md:text-2xl lg:text-3xl text-muted-foreground mb-8 font-light">
              Web Developer and Passionate About Creating Clean, Modern Apps, and User-Friendly{" "}
          ...
          <div className="animate-fade-in-up flex justify-center space-x-6" style={{animationDelay: '0.8s'}}>
            <a 
              href="https://github.com/mohanveesam" 
              target="_blank" 
